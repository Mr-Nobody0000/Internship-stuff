  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex items-end">
      <AnimatePresence>
        {isOpen && (
          <motion.div
            className="mb-4 mr-4 w-80 sm:w-96 glass-card rounded-2xl overflow-hidden"
            initial={{ opacity: 0, y: 20, scale: 0.9 }}
            animate={{ opacity: 1, y: 0, scale: 1 }}
            exit={{ opacity: 0, y: 20, scale: 0.9 }}
            transition={{ duration: 0.3 }}
          >
            <div className="bg-gradient-to-r from-[#0a0f18] to-[#141e2c] p-4 flex justify-between items-center border-b border-[#334155]">
              <div className="flex items-center">
                <div className="relative">
                  ...
                  />
                  <span className="absolute bottom-0 right-0 w-3 h-3 bg-green-500 rounded-full border-2 border-[#141e2c]"></span>
                </div>
                <div className="ml-3">
            ...
            >
              ...
              {isTyping && (
                <div className="mb-4 flex justify-start">
                  ...
                  <div className="glass-effect p-3 rounded-lg text-white">
            ...
            <div className="p-4 border-t border-[#334155] bg-[#0a0f18]">
              <div className="flex items-center">
                <textarea
                  value={message}
                  ...
                  className="flex-grow glass-effect border border-[#334155] rounded-lg p-2 text-white placeholder:text-gray-400 focus:outline-none focus:ring-1 focus:ring-[#3b82f6] resize-none h-10 min-h-[40px] max-h-32"
                  rows={1}
                ></textarea>
                <button
              ...
              <div className="mt-2 text-xs text-gray-500 flex items-center justify-center">
                <Sparkles className="h-3 w-3 mr-1 text-[#3b82f6]" />
      ...
      <div className="relative">
        <AnimatePresence>
          {isHovered && !isOpen && (
            <motion.div
              className="absolute bottom-full right-0 mb-2 glass-effect text-white py-2 px-4 rounded-lg text-sm font-medium"
        ...
        <motion.button
          className="bg-gradient-to-r from-[#3b82f6] to-[#8b5cf6] text-white p-4 rounded-full flex items-center justify-center shadow-lg shadow-[#3b82f6]/20"
          onClick={toggleChat}
